            ...
            >
              ...
              <div className="relative h-48 w-full overflow-hidden">
                ...
                <div className="absolute top-4 right-4 z-20">
                     <div className={`p-2 rounded-lg backdrop-blur-md bg-black/40 border border-white/10 ${service.category === 'blue' ? 'text-[#00A4FF]' : 'text-[#FF00C8]'}`}>
              ...
              <div className="p-6 flex-1 flex flex-col relative z-20 -mt-2">
                 <div className="flex justify-between items-center mb-3">
                     <h3 className="text-xl font-bold text-white group-hover:text-[#00A4FF] transition-colors">
                        {service.title}
                    </h3>
                ...
                <div className="pt-4 border-t border-white/5 flex items-center justify-between">
                   <span className="text-xs font-medium text-white/50 group-hover:text-[#00FF9D] transition-colors">
                      Cliquez pour voir les détails
                   </span>
                   <button className="text-xs font-bold uppercase tracking-wider text-white hover:text-[#00A4FF]">
                       Détails +
                   </button>
                </div>
              </div>
      ...
      >
        <div className="space-y-6">
            <div className="flex items-start gap-4">
                <div className={`p-3 rounded-xl bg-white/5 ${selectedService?.category === 'purple' ? 'text-[#FF00C8]' : 'text-[#00A4FF]'}`}>
            ...
            <div>
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {selectedService?.details?.map((detail, index) => (
                        <li key={index} className="flex items-start gap-3 p-3 rounded-lg bg-white/5 border border-white/5 hover:border-[#00A4FF]/30 transition-colors">
            ...
            <div className="bg-[#00A4FF]/10 p-4 rounded-lg border border-[#00A4FF]/20">
                <p className="text-sm text-[#00A4FF] text-center font-medium">
